...
\begin{equation}
    \sqrt{1-4z} = \sum_{n=0}^\infty \begin{pmatrix}
        1/2\\n
    \end{pmatrix} (-4z)^n = 1+\sum_{n=1}^\infty \frac{\left(\frac{1}{2}\right)\left(-\frac{1}{2}\right)\dots \left(\frac{3}{2}-n\right)}{n!}(-1)^n 2^{2^n}z^n
\end{equation}
Which gives 
\begin{equation}
    f(z) = -\frac{1}{2z} \sum_{n=1}^\infty \frac{\left(\frac{1}{2}\right)\left(-\frac{1}{2}\right)\dots \left(\frac{3}{2}-n\right)}{n!}(-1)^n 2^{2^n}z^n
\end{equation}
...
The time complexity is $\Theta(n\log(n))+\Theta(n)$, as we first need to sort the activities and then do once through the array.
