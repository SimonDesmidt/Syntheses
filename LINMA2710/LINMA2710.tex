...
SIMD takes advantages of \textbf{vector registers}, to perform the same operation on multiple data elements in parallel within a single CPU cycle. It take advatages of an extension of a CPU architectures that uses specific register to store the vector on which it does instruction from a specific set of instructions. It increases throughput of processed data.\\
