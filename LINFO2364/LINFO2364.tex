...
\end{definition}
If no rules fires, we can use a \textbf{default rule} that predicts the most frequent class in the learning set or even predict an "unknown" class, this "unknown" class can be interesting as not knowing something can carry information.\\
\chapter{Clustering}
\end{document}