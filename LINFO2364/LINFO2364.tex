...
The biclustering is a type of clustering that allows to cluster to be in two dimensions. \textcolor{red}{TODO: idk what to say}
...
\begin{definition}
    ...
    \begin{equation}
    \texttt{diameter}(G) = \max_{v \in V}texttt{eccen}(v)
    \end{equation}
\end{definition}
\begin{definition}
...
\textcolor{red}{TODO: constrained k-means}
We could also need \textbf{pairwise constraint} such as:
\begin{definition}
