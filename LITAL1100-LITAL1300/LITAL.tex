...
\subsection{Cas particuliers au TU/LEI}
\begin{center}
    \begin{tabular}{c|c|c}
        Indicativo (tu) & tu & Lei\\ \hline 
        vai & va' & vada \\
        fai & fa' & faccia \\
        stai & sta' & stia \\
        dai (dare = donner) & da' & dia \\
        dici (dire = dire) & di' & dica \\
        essere & sii/cerca di essere (à l'oral) & sia\\
        avere & abbi & abbia\\ 
    \end{tabular}
\end{center}
...
\end{center}
Son utilisation est la même qu'en français. 
\section{Subjonctif présent (congiuntivo)}
Le subjonctif s'utilise pour exprimer des idées, des opinions, des hypothèses, des incertitudes ; principalement dans des P2 de complément. 
\begin{center}
    \begin{tabular}{c|c|c}
        & Essere & Avere \\ \hline 
        io & sia & abbia \\
...
\begin{center}
    ...
    \end{tabular}
\end{center}
La forme générale se base sur l'impératif du "Lei", et a donc les mêmes verbes irréguliers. 
\subsection{Subjonctif passé}
Le subjonctif passé se forme comme tous les autres temps composés : 
\begin{center}
    sujet + essere/avere conjugué + participe passé (éventuellement accordé) + compléments 
\end{center}
\section{Subjonctif imparfait}
\begin{center}
    \begin{tabular}{c|c|c}
        & Essere & Avere \\ \hline 
        io & fossi & avessi \\
...
Il y a très peu de verbes irréguliers au subjonctif imparfait. La majorité se base sur leur forme de l'indicatif imparfait, à l'exception de dare et stare. 
\begin{center}
    \begin{tabular}{c|c|c}
        Infinitif & Indicatif imparfait & Subjonctif imparfait\\ \hline 
        Dire & dic-evo & dic-essi \\
        Fare & fac-evo & fac-essi\\
        Proporre & propon-evo & propon-essi\\
        Tradurre & traduc-evo & traduc-essi\\
        Dare & da-vo & dessi\\
        Stare & sta-vo & stessi
    \end{tabular}
\end{center}
\subsection{Subjonctif plus-que-parfait}
Le subjonctif plus-que-parfait se forme comme tous les autres temps composés : 
\begin{center}
    sujet + essere/avere conjugué + participe passé (éventuellement accordé) + compléments 
\end{center}
...
\section{Magari !}
\begin{enumerate}
    \item "Magari" peut vouloir dire "peut-être" et s'utilise alors avec l'indicatif présent. Par exemple, "- Stasera vado al cinema a vedere l'ultimo film di Nanni Moretti. - Magari vengo anch'io, se ho tempo."
    \item "Magari" peut exprimer un désir peu probable mais théoriquement encore possible à réaliser. Il s'utilise alors avec un subjonctif imparfait. Par exemple, "- Mario, vieni al cinema con noi stasera? - Magari potessi! Ho un sacco di lavoro da finire."
    \item "Magari" peut exprimer un désir irréalisable (mais qui aurait pu l'être dans le passé). Il s'utilise alors avec le subjonctif plus-que-parfait. Par exemple, "- Sai, ieri sera siamo andati a vedere l'ultimo film di Moretti. Veramente bello! - Magari fossi potuto venir! Avevo un sacco di lavoro da finire."
\end{enumerate}
\section{Vocabulaire}
